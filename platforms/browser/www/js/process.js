...
Framework7.prototype.plugins.k12 = function (app, params) {
	...
	// main grading process
		...
		var list_gradingSheet = function(){	
	        ...
	        $$.each(data_gradesAll,function(index_grade,value_grade){
				...
				$$.each(data_students,function(index_genderInner,value_genderInner){
					...
					headers =   "<tr>"+
								...
								"</tr>";
					sub_content +=  "<tr>"+
									"	<td>"+value_genderInner[7]+" "+value_genderInner[8]+"</td><td>"+value_genderInner[10]+"</td>"+
										sub_columnContent+
			...
			var table = $('._listStudent, ._finalGrade').DataTable({
		        "columnDefs": [
			...
			// $(".DTFC_LeftBodyWrapper").attr({"style":"min-width:200px !important;"});
			// $(".DTFC_LeftBodyLiner").attr({"style":"min-width:200px !important;"});
			// console.log("xx");
		};
